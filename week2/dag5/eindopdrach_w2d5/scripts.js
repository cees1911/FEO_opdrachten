    ...
    rbt.addEventListener('change', () => {
        ...
        switch(stringForSwitch){
            ...
            case 'NieuweFilms': 
                ...
                const findEventPoster5 = movies.filter((filterObject) =>{
                    return filterObject.Year.includes('2014') || filterObject.Year.includes('2015') || filterObject.Year.includes('2016')
                    || filterObject.Year.includes('2017') || filterObject.Year.includes('2018') || filterObject.Year.includes('2019')
                    || filterObject.Year.includes('2020');}).map(adv => adv.Poster);

                const findEventId5 = movies.filter((filterObject) =>{
                    return filterObject.Year.includes('2014') || filterObject.Year.includes('2015') || filterObject.Year.includes('2016')
                    || filterObject.Year.includes('2017') || filterObject.Year.includes('2018') || filterObject.Year.includes('2019')
                    || filterObject.Year.includes('2020');}).map(adId => adId.imdbID);
